...
```text
  ...
  | PostgreSQL       |       | PostgreSQL + Kafka  |       | Dashboard APIs      |
  +------------------+       +----------+----------+       +---------------------+
                                         |
                                         v
                                Kafka Topics
 ...
 | MongoDB + Kafka      |     | PostgreSQL + Kafka   |      | PostgreSQL + Kafka   |
 +----------------------+     +----------------------+      +----------------------+
...
### reconciliation-service PostgreSQL
...
- Add Testcontainers for PostgreSQL, MongoDB, and Kafka integration tests.
